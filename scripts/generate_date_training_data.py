#!/usr/bin/env python3
"""
Generate training data for the date key extraction adapter.

This script creates a JSONL file with examples mapping natural language
date/time phrases to standardized semantic keys.

Usage:
    python scripts/generate_date_training_data.py
    
Output:
    data/date_keys_training.jsonl
"""
...
# Output file
OUTPUT_FILE = Path(__file__).parent.parent / "data" / "date_keys_training.jsonl"
...
def main():
    ...
    print("=" * 60)
    print("DATE KEY TRAINING DATA GENERATOR")
    print("=" * 60)
