...
SETTINGS_DEFINITIONS: list[SettingDefinition] = [
    ...
    SettingDefinition(
        ...
        value_type="int",
        default=0,
        description="Multi-GPU split: 0=single GPU (main_gpu only), 1=split layers, 2=split rows. Auto-split across all visible GPUs is opt-in to avoid using unsupported iGPUs.",
