...
SETTINGS_DEFINITIONS: list[SettingDefinition] = [
    ...
    SettingDefinition(
        key="model.lightweight.stop_tokens",
        category="model.lightweight",
        value_type="string",
        default="",
        description="Comma-separated stop tokens for lightweight model",
        env_fallback="JARVIS_LIGHTWEIGHT_MODEL_STOP_TOKENS",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.lightweight.rest_url",
        category="model.lightweight",
        value_type="string",
        default="",
        description="REST URL for lightweight model backend",
        env_fallback="JARVIS_REST_LIGHTWEIGHT_MODEL_URL",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.lightweight.rest_model_name",
        category="model.lightweight",
        value_type="string",
        default="",
        description="REST model name override for lightweight model",
        env_fallback="JARVIS_REST_LIGHTWEIGHT_MODEL_NAME",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.cloud.chat_format",
        category="model.cloud",
        value_type="string",
        default="",
        description="Cloud model chat format",
        env_fallback="JARVIS_CLOUD_MODEL_CHAT_FORMAT",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.cloud.rest_url",
        category="model.cloud",
        value_type="string",
        default="",
        description="REST URL for cloud model backend",
        env_fallback="JARVIS_CLOUD_REST_MODEL_URL",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.vision.rest_url",
        category="model.vision",
        value_type="string",
        default="",
        description="REST URL for vision model backend",
        env_fallback="JARVIS_VISION_REST_MODEL_URL",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.vision.attn_impl",
        category="model.vision",
        value_type="string",
        default="",
        description="Transformers attention implementation override for vision models",
        env_fallback="JARVIS_VISION_ATTN_IMPL",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.vision.torch_dtype",
        category="model.vision",
        value_type="string",
        default="",
        description="Torch dtype override for vision models",
        env_fallback="JARVIS_VISION_TORCH_DTYPE",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.vision.vllm_max_batched_tokens",
        category="model.vision",
        value_type="int",
        default=4096,
        description="Vision vLLM max batched tokens",
        env_fallback="JARVIS_VISION_VLLM_MAX_BATCHED_TOKENS",
        requires_reload=True,
    ),
    SettingDefinition(
        key="model.vision.vllm_max_num_seqs",
        category="model.vision",
        value_type="int",
        default=8,
        description="Vision vLLM max sequences",
        env_fallback="JARVIS_VISION_VLLM_MAX_NUM_SEQS",
        requires_reload=True,
    ),
    # ==================== cache ====================
    SettingDefinition(
